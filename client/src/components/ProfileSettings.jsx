                                ...
                                <CardContent className="pt-0 pb-8 px-8 -mt-16 relative">
                                    <div className="flex flex-col items-center">
                                        <div className="relative group">
                                            <Avatar className="w-32 h-32 rounded-3xl border-4 border-white shadow-2xl ring-4 ring-slate-100 group-hover:scale-105 transition-all duration-300">
                                                {formData.avatar ? (
                                                    ...
                                                    <AvatarFallback className="bg-gradient-to-br from-slate-900 to-slate-700 text-white text-4xl font-black">
                                                        {formData.name ? formData.name.split(' ').map(n => n[0]).join('').toUpperCase() : 'U'}
                                                    </AvatarFallback>
                                                )}
                                            </Avatar>
                                            <label className="absolute -bottom-2 -right-2 w-12 h-12 bg-gradient-to-br from-[#4285f4] to-[#8b5cf6] text-white rounded-2xl flex items-center justify-center shadow-xl shadow-[#4285f4]/30 hover:shadow-2xl hover:scale-110 transition-all cursor-pointer border-4 border-white">
                                                {uploadingAvatar ? (
                                        ...
                                        <div className="text-center mt-6 w-full">
                                            <h3 className="text-2xl font-black text-slate-900 tracking-tight">{formData.name || 'Your Name'}</h3>
                                            <Badge className="mt-3 bg-gradient-to-r from-[#4285f4] to-[#8b5cf6] text-white border-none px-4 py-1.5 text-xs font-bold uppercase tracking-wider">
                                                {user?.role || 'User'}
                                            </Badge>
                                        </div>
                                ...
                                <CardHeader className="pb-6 border-b border-slate-100">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-slate-500 font-medium mt-0.5">Your personal details</p>
                                        </div>
                                    </div>
                                </CardHeader>
