                ...
                <Card className="p-6 bg-slate-900 text-white border-none shadow-xl">
                    <div className="flex items-start justify-between">
                        ...
                        <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-lg">
                            ...
                            <span className="font-semibold">{candidates.length} Candidates Analyzed</span>
                        </div>
                    </div>
                </Card>
            </motion.div>
                                        ...
                                        <div className="flex items-start justify-between mb-2">
                                            ...
                                            <div className="text-right">
                                                <div className="flex items-center gap-2 mb-1 justify-end">
                                                    ...
                                                    <Badge className={candidate.matchScore > 70 ? 'bg-emerald-500' : 'bg-yellow-500'}>
                                                        Match
                                                    </Badge>
                                                </div>
                                                <Progress value={candidate.matchScore} className="w-32 h-2 ml-auto" />
                                            </div>
                                        </div>
